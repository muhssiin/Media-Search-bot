...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('Update Channel', url='https://t.me/mcubemediaofficial'),
                    InlineKeyboardButton('Source Code', url='https://t.me/smplmcube/7')
                ]
                ]
            await query.message.edit(text="<b>Developer : <a href='https://t.me/subinps_bot'>SUBIN</a>\nEditor :<a href='https://t.me/rashmikamandannaofficial1'>RASHMIKA</a>\nLanguage : <code>Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\nSource Code : <a href='https://t.me/smplmcube/7'>Click here</a>\nUpdate Channel : <a href='https://t.me/mcubemediaofficial'>MCubeMedia</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
            ...
            for files in filedetails:
                ...
                size=files.get_size(file.file_size)
                ...
                buttons = [
                    [
                        InlineKeyboardButton('Support Group', url='https://t.me/MCubeMediaSupport'),
                        InlineKeyboardButton('Update Channel', url='https://t.me/mcubemediaofficial')
                    ]
                    ]
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('Suoport Group', url='https://t.me/MCubeMediaSupport'),
                        InlineKeyboardButton('Update Channel', url='https://t.me/mcubemediaofficial')
                    ]
                    ]
